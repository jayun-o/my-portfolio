        ...
        <Layout className='pt-0 md:pt-16 sm:pt-8'>
          <div className='flex items-center justify-between w-full lg:flex-col'>
            <div className='w-1/2 md:w-full'>
              <Image src={profilePic} alt="WhalePortfolio" className='w-full h-auto lg:hidden md:inline-block md:w-full'
              priority
            ...
            <div className='flex flex-col items-center self-center w-1/2 lg:w-full lg:text-center'>
              <AnimatedText text="Hi, I'm Beam Wannasiri" className='!text-6xl !text-left xl:text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl'/>
              <p className='my-4 text-base font-medium md:text-sm sm:text-xs'>
              As a Full Stack-developer, Front-end developer, Back-end developer, Finding a new opportunity work              </p>
              <div className='flex items-center self-start mt-2 lg:self-center'>
                <Link href="/WSresume.pdf" target={"_blank"}
                ...
                <Link href="mailto:wannasiri.sb@gmail.com" target={"_blank"} className='ml-4 text-lg font-medium underline capitalize text-dark dark:text-light md:text-base '>Contact</Link>
              </div>
            </div>
          </div>
        </Layout>
